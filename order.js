    ...
    const PANEL_CHANNEL_ID = '1491121826405814547';
    const TICKET_CATEGORY_ID = '1491121827613769817';
    const TRANSCRIPT_CHANNEL_ID = '1491121827613769814';

    const bannerUrl = 'https://media.discordapp.net/attachments/1491121827613769809/1493964528441098440/services.png?ex=69e38564&is=69e233e4&hm=144ff04b20504aca4c8293fc995cb78082e106488023b07001b68d1e74ba2fb5&=&format=webp&quality=lossless&width=1768&height=530';
    ...
    client.on('messageCreate', async (message) => {
        ...
        if (message.content !== '-sendOrder') return;
    ...
    const container = new ContainerBuilder()
        ...
        .setContent(
            '## `🛒` Order\n\nThis is where your vision comes to life. We create custom, high-quality designs built around your ideas and brand identity. Whether you need a logo, banner, livery, or a complete branding package, we focus on a clean, professional result that makes an impact. Review the order ToS and submit your order whenever you feel ready!')
    ...
    .setPlaceholder('View our Order ToS')
    .addOptions(
...
.setLabel('Dashboard')
.setURL('https://discord.com/channels/1491121825181208826/1491121826099626238')
            )
        );
...
All members must follow Discord’s Terms of Service at all times to keep the server safe and compliant.`
    ...
    const reasonInput = new TextInputBuilder()
        ...
        .setLabel('What would you like the order?')
